...
console.log(result);
//------------------------------------------
//max and min value in three degit value----------
...
//-------------------------------------------------------
//single degit number using if else---------------
let num =3;
if(num==1)
{
    console.log("one");
